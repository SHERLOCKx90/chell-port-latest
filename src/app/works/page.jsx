...
// //       <div className='m-10 grid grid-flow-row md:grid-cols-2 lg:grid-cols-4 gap-4'>
// //         <UiCards />
// //         <UiCards />
// //         <WorkCards />
// //         <WorkCards />
...
//     },
//     {
//       uiname: "Paintball Poster Design", 
//       uitag: "A decentralized platform for music NFTs.",
//       uilink: "https://github.com/SHERLOCKx90/BeatSpire-Main-Fix",
//     },
//   ]
...
//     <div className='flex justify-center items-start min-h-screen'>
//       <div className='m-10 grid grid-flow-row md:grid-cols-2 lg:grid-cols-4 gap-4'>
//         {/* Rendering UI Cards with merged data */}
//         {uiarray.map((ui, index) => (
//           <UiCards
//             key={`ui-${index}`}
//             image={ui}
//             name={uiWorkArray[index].uiname}
//             tag={uiWorkArray[index].uitag}
//             link={uiWorkArray[index].uilink}
//           />
//         ))}

//         {/* Rendering Work Cards with merged data */}
//         {codearray.map((code, index) => (
//           <WorkCards
//             key={`code-${index}`}
//             image={code}
//             name={codeWorkArray[index].codename}
//             tag={codeWorkArray[index].codetag}
//             link={codeWorkArray[index].codelink}
//           />
//         ))}
//       </div>
//     </div>
